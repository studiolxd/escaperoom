...
(Mixamo: Happy Idle, Walking in place, Picking Up) → render isométrico 2:1 en Blender (`scripts/blender/render_animaciones.py`)
→ empaquetado (`scripts/empaquetar/empaquetar_avatar.py`). Luz única arriba-izquierda, sin sombra de contacto, fondo transparente.

## Contenido
- `2x/` 128×192 y `1x/` 64×96: 80 frames PNG con alfa, nombres `avatar-caballero-m-<dir>-<acción>-<n>` (con prefijo de personaje, ver `packs/medieval-v1/docs/integracion/historial/cambios-escaperoom-avatares.md` B4).
...
Detallados y justificados en `packs/medieval-v1/docs/integracion/historial/cambios-escaperoom-avatares.md` (pivote, direcciones, nº de frames,
