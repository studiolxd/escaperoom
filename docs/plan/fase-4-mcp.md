...
| 4.9 | **Créditos IA + ElevenLabs** | Ledger de créditos (código de SLXD copiado/adaptado, ADR-017), `applyCreditMovement`, botón "Generar con IA" (previsualización gratis, consumo al confirmar) | `15` §2–3, `14` §4 | Generar un audio descuenta créditos y traza `reference_id = {dialogId}:{locale}` |
