...
/**
 * POST /api/audio/uploads — sube un MP3 propio; queda disponible al instante,
 * sin moderación previa (ADR-039). Cuota `audio-upload` (hueco encontrado al
 * revisar la PR #168, D-12: no tenía; comparte cupo con la meta-tool `upload`
 * del MCP).
 */
